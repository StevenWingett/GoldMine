...
Installation
------------
Before running GodMine there are a few pre-requisites that will need to be installed:
...
Running the program
-------------------
To confirm GoldMine functions correctly on your system please download the Test Dataset. The file 'goldmine_test_dataset.fastq.gz' contains reads in Sanger FASTQ format.

1. Extract the tar archive before processing: tar xvzf goldmine_test_dataset.tar.gz
